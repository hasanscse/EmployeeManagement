...
namespace EmployeeManagement.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        {
            if (_context.Departments.Any(i => i.DEPARTMENT_NAME == department.DEPARTMENT_NAME))
            {
                ModelState.AddModelError("Departments.DEPARTMENT_NAME", "The department is already in use.");
                ViewBag.Message = "The department is already in use.";
                return View(department);
            }
